...
package org.wso2.micro.gateway.enforcer.listener;
...
public class JMSMessageListener implements MessageListener {
    ...
    public static void init() {
        ...
        String eventReceiverURL = "amqp://admin:admin@carbon/carbon?brokerlist='tcp://localhost:5672'";
        Runnable runnable = () -> {
            try {
                ...
                listener.setMessageListener(new JMSMessageListener());
            } catch (NamingException | JMSException e) {
                log.error("Error while initiating jms connection for throttle data...", e);
            }
        };
